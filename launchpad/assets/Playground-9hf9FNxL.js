import{r as e,t}from"./react-D6Jy4RLT.js";import{K as n,X as r,g as i,r as ee,v as te,w as ne}from"./ui-5JSjpmHC.js";import{x as a}from"./curriculum-rLod3J6P.js";import{S as o}from"./engine-BhleXMOO.js";import{_ as re,g as s}from"./index-D3o5H9tY.js";import{t as c}from"./markdown-CW5NPVRI.js";/* empty css              */import{C as l,S as u,_ as ie,a as d,b as ae,c as oe,d as se,f,g as ce,h as p,i as le,l as ue,m as de,n as fe,o as pe,p as me,r as he,s as ge,t as _e,u as ve,useNextLesson as ye,v as be,x as xe,y as Se}from"./Learn-C3YPNxRR.js";var m=e(),h=t(),Ce=[`python`,`javascript`,`typescript`,`cpp`],g={javascript:`main.js`,typescript:`main.ts`,python:`main.py`,cpp:`main.cpp`,sql:`query.sql`,html:`index.html`,bash:`~/project`};function _(e){return e===`sql`?`sql`:e===`html`?`web`:e===`bash`?`terminal`:`code`}var v={typescript:`// M3: a discriminated union, and the compiler holding you to every case.
