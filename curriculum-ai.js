...
M0:[
 ...
 ['Module','One unit of this program, up to four weeks long. Each ends with a thing you made and a check by someone else. On the Modules tab each shows three ticks: delta (your notes), artifact (the thing built), gate (a referee said yes).'],
...
M3:[
 ...
 ['Library, package','Code someone else wrote that you add to your project and call from your own. Node installs one with npm, the package-installing tool that comes with Node; Zod is an example.'],
...
M6:[
 ...
 ['Prompt caching, cache hit','The service remembers the start of a prompt you sent recently and charges a fraction to read it again. A hit is when that happened, visible in the usage object. Same idea as the M5 cache, on the provider\'s side (the provider is the company running the model service).'],
