...
// B0 · The asset — a product of three terms; a zero anywhere zeroes it.
b0_asset:
'<svg viewBox="0 0 320 190" width="100%" height="190" xmlns="http://www.w3.org/2000/svg" font-family="DM Sans,sans-serif">'
+'<text x="160" y="14" fill="#a9a9a9" font-size="10" text-anchor="middle">The brand asset multiplies — it never adds</text>'
+'<rect x="16" y="34" width="84" height="44" rx="9" fill="#1c0e0e" stroke="#ffb020" stroke-width="1.2"/>'
+'<text x="58" y="53" fill="#ffb020" font-size="9.5" text-anchor="middle">ATTENTION</text>'
+'<text x="58" y="67" fill="#a9a9a9" font-size="7.5" text-anchor="middle">summoned eyes</text>'
+'<text x="112" y="60" fill="#d8d8d8" font-size="14" text-anchor="middle">×</text>'
+'<rect x="124" y="34" width="72" height="44" rx="9" fill="#0f1a12" stroke="#00e5a0" stroke-width="1.2"/>'
+'<text x="160" y="53" fill="#00e5a0" font-size="9.5" text-anchor="middle">TRUST</text>'
+'<text x="160" y="67" fill="#a9a9a9" font-size="7.5" text-anchor="middle">parasocial</text>'
+'<text x="208" y="60" fill="#d8d8d8" font-size="14" text-anchor="middle">×</text>'
+'<rect x="220" y="34" width="84" height="44" rx="9" fill="#140a0a" stroke="#d8d8d8" stroke-width="1.2"/>'
+'<text x="262" y="53" fill="#ece0df" font-size="9.5" text-anchor="middle">PROOF</text>'
+'<text x="262" y="67" fill="#a9a9a9" font-size="7.5" text-anchor="middle">receipts</text>'
+'<rect x="30" y="104" width="120" height="34" rx="8" fill="#1a0d0d" stroke="#ff4455" stroke-width="1.2"/>'
+'<text x="90" y="118" fill="#ff6a5f" font-size="8.5" text-anchor="middle">100k × 0 × 0 = 0</text>'
+'<text x="90" y="130" fill="#a9a9a9" font-size="7.5" text-anchor="middle">bought reach, no trust</text>'
+'<rect x="170" y="104" width="120" height="34" rx="8" fill="#0f1a12" stroke="#00e5a0" stroke-width="1.2"/>'
+'<text x="230" y="118" fill="#00e5a0" font-size="8.5" text-anchor="middle">4k × deep × real = deals</text>'
+'<text x="230" y="130" fill="#a9a9a9" font-size="7.5" text-anchor="middle">one metro, receipts shown</text>'
+'<circle r="3.5" fill="#00e5a0"><animateMotion dur="2.6s" repeatCount="indefinite" path="M100 56 L124 56"/></circle>'
+'<circle r="3.5" fill="#00e5a0"><animateMotion dur="2.6s" begin="1.3s" repeatCount="indefinite" path="M196 56 L220 56"/></circle>'
+'<text x="160" y="164" fill="#7a7a7a" font-size="8.5" text-anchor="middle">Followers are a proxy for one term. A zero anywhere zeroes the product.</text>'
+'<text x="160" y="178" fill="#7a7a7a" font-size="8" text-anchor="middle">Bought followers = rented tradelines: the algorithm-underwriter discounts them</text>'
+'</svg>',

// B2 · The test-pool ladder — pass the exam, get a bigger exam.
b2_algo:
'<svg viewBox="0 0 320 204" width="100%" height="204" xmlns="http://www.w3.org/2000/svg" font-family="DM Sans,sans-serif">'
+'<text x="160" y="14" fill="#a9a9a9" font-size="10" text-anchor="middle">Virality = the same exam at escalating scale</text>'
+'<rect x="20" y="28" width="60" height="26" rx="7" fill="#140a0a" stroke="#d8d8d8"/>'
+'<text x="50" y="45" fill="#ece0df" font-size="8.5" text-anchor="middle">UPLOAD</text>'
+'<rect x="104" y="28" width="86" height="26" rx="7" fill="#140a0a" stroke="#d8d8d8"/>'
+'<text x="147" y="40" fill="#ece0df" font-size="8" text-anchor="middle">POOL 1 · ~400</text>'
+'<text x="147" y="50" fill="#a9a9a9" font-size="7" text-anchor="middle">watch? share? save?</text>'
+'<rect x="104" y="76" width="120" height="26" rx="7" fill="#140a0a" stroke="#d8d8d8"/>'
+'<text x="164" y="88" fill="#ece0df" font-size="8" text-anchor="middle">POOL 2 · ~4,000</text>'
+'<text x="164" y="98" fill="#a9a9a9" font-size="7" text-anchor="middle">same exam, colder crowd</text>'
+'<rect x="104" y="124" width="160" height="26" rx="7" fill="#1c0e0e" stroke="#ffb020" stroke-width="1.1"/>'
+'<text x="184" y="136" fill="#ffb020" font-size="8" text-anchor="middle">POOL 3 · ~40,000</text>'
+'<text x="184" y="146" fill="#a9a9a9" font-size="7" text-anchor="middle">signals decide again</text>'
+'<path d="M80 41 L104 41" stroke="#7a7a7a" stroke-width="1"/>'
+'<path d="M147 54 L147 76" stroke="#00e5a0" stroke-width="1.3"/>'
+'<text x="158" y="68" fill="#00e5a0" font-size="7" text-anchor="start">pass</text>'
+'<path d="M164 102 L164 124" stroke="#00e5a0" stroke-width="1.3"/>'
+'<circle r="3.5" fill="#00e5a0"><animateMotion dur="3.4s" repeatCount="indefinite" path="M147 54 L147 76 M164 102 L164 124" keyPoints="0;1" keyTimes="0;1"/></circle>'
+'<path d="M232 41 L262 41" stroke="#ff4455" stroke-width="1.2" stroke-dasharray="4 3"/>'
+'<text x="286" y="44" fill="#ff6a5f" font-size="7.5" text-anchor="middle">fail = quiet stop</text>'
+'<text x="160" y="172" fill="#7a7a7a" font-size="8.5" text-anchor="middle">Signals ranked: watch/re-watch &gt; share &gt; save &gt; comment &gt; like</text>'
+'<text x="160" y="188" fill="#7a7a7a" font-size="8" text-anchor="middle">Your account file routes the FIRST pool — coherence is payment history</text>'
+'</svg>',

// B3 · The funnel — rented reach walks down into an owned deal room.
b3_funnel:
'<svg viewBox="0 0 320 204" width="100%" height="204" xmlns="http://www.w3.org/2000/svg" font-family="DM Sans,sans-serif">'
+'<text x="160" y="14" fill="#a9a9a9" font-size="10" text-anchor="middle">Every deal walks the same staircase</text>'
+'<rect x="20" y="28" width="280" height="28" rx="8" fill="#140a0a" stroke="#d8d8d8"/>'
+'<text x="160" y="46" fill="#ece0df" font-size="9" text-anchor="middle">CLIP — wins the stranger’s 3 seconds</text>'
+'<rect x="46" y="70" width="228" height="28" rx="8" fill="#140a0a" stroke="#d8d8d8"/>'
+'<text x="160" y="88" fill="#ece0df" font-size="9" text-anchor="middle">PROFILE — 4-second storefront</text>'
+'<rect x="72" y="112" width="176" height="28" rx="8" fill="#1c0e0e" stroke="#ffb020" stroke-width="1.1"/>'
+'<text x="160" y="130" fill="#ffb020" font-size="9" text-anchor="middle">DM — speed + the script</text>'
+'<rect x="98" y="154" width="124" height="28" rx="8" fill="#0f1a12" stroke="#00e5a0" stroke-width="1.3"/>'
+'<text x="160" y="172" fill="#00e5a0" font-size="9" text-anchor="middle">DEAL — off-platform</text>'
+'<circle r="4" fill="#ffb020"><animateMotion dur="3.6s" repeatCount="indefinite" path="M160 56 L160 70 M160 98 L160 112 M160 140 L160 154" keyPoints="0;1" keyTimes="0;1"/></circle>'
+'<text x="160" y="198" fill="#7a7a7a" font-size="8" text-anchor="middle">Growth content fills the top · conversion content opens the DMs · the CRM owns the bottom</text>'
+'</svg>',

// B4 · Rented vs leased vs owned — who can turn your reach off?
b4_owned:
'<svg viewBox="0 0 320 196" width="100%" height="196" xmlns="http://www.w3.org/2000/svg" font-family="DM Sans,sans-serif">'
+'<text x="160" y="14" fill="#a9a9a9" font-size="10" text-anchor="middle">Who can turn it off? The only question of ownership</text>'
+'<rect x="20" y="30" width="88" height="74" rx="9" fill="#1a0d0d" stroke="#ff4455" stroke-width="1.2"/>'
+'<text x="64" y="48" fill="#ff6a5f" font-size="9" text-anchor="middle">RENTED</text>'
+'<text x="64" y="62" fill="#a9a9a9" font-size="7.5" text-anchor="middle">algorithmic reach</text>'
+'<text x="64" y="80" fill="#ff6a5f" font-size="7.5" text-anchor="middle">repriced any morning</text>'
+'<rect x="116" y="30" width="88" height="74" rx="9" fill="#1c0e0e" stroke="#ffb020" stroke-width="1.2"/>'
+'<text x="160" y="48" fill="#ffb020" font-size="9" text-anchor="middle">LEASED</text>'
+'<text x="160" y="62" fill="#a9a9a9" font-size="7.5" text-anchor="middle">your followers</text>'
+'<text x="160" y="80" fill="#ffb020" font-size="7.5" text-anchor="middle">delivery throttled</text>'
+'<rect x="212" y="30" width="88" height="74" rx="9" fill="#0f1a12" stroke="#00e5a0" stroke-width="1.3"/>'
+'<text x="256" y="48" fill="#00e5a0" font-size="9" text-anchor="middle">OWNED</text>'
+'<text x="256" y="62" fill="#a9a9a9" font-size="7.5" text-anchor="middle">phone · email · CRM</text>'
+'<text x="256" y="80" fill="#00e5a0" font-size="7.5" text-anchor="middle">nobody in between</text>'
+'<circle r="3.5" fill="#ffb020"><animateMotion dur="2.8s" repeatCount="indefinite" path="M108 67 L116 67"/></circle>'
+'<circle r="3.5" fill="#00e5a0"><animateMotion dur="2.8s" begin="1.4s" repeatCount="indefinite" path="M204 67 L212 67"/></circle>'
+'<text x="160" y="128" fill="#a9a9a9" font-size="8.5" text-anchor="middle">Every viral moment converts some rented attention into owned ground</text>'
