        ...
        <div className="page-head">
          <div>
            ...
            <p className="page-head__sub">
              {PLACEMENT_QUESTIONS.length} short questions, one or two for each
              skill the course is built on. {PLACEMENT_QUESTIONS.length > 20 ? 'About fifteen to twenty minutes.' : 'About five minutes.'} At the end you get a plan: the lessons
