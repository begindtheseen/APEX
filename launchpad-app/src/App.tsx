...
function Routed() {
  ...
  useEffect(() => {
    document.title = `${titleFor(route.path)} · LAUNCHPAD`
  }, [route.path])
...
function titleFor(path: string): string {
  ...
  const layer = TRACKS[seg as TrackId]
      ...
      <div className="page-head">
        <div>
          ...
          <p className="page-head__sub">
            That route does not exist. Head back to the dashboard and pick a layer.
          </p>
        </div>
      </div>
