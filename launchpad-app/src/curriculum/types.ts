/* ============================================================================
   LAUNCHPAD — curriculum schema (the ORBIT schema, carrying LAUNCHPAD modules)
   ----------------------------------------------------------------------------
...
import type { LpModule } from './generated/launchpad-data'
...
export interface Module {
  ...
  importance?: number
  /**
   * The LAUNCHPAD module this was built from, untouched: the artifact, the
   * checkpoints, the gate and its referee, the words, the pitfalls. Every
   * LAUNCHPAD-specific surface reads from here rather than from a copy.
   */
  lp?: LpModule
}
