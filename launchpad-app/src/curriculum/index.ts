...
import { LAUNCHPAD_MODULES } from './launchpad'
...
export const MODULES: Module[] = LAUNCHPAD_MODULES.map((m) => {
...
export { LAYER_SLUGS, TRACKS, TRACK_ORDER, layerOf, trackDef, trackForLayer, trackPath } from './tracks'
