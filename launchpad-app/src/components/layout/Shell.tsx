/* ============================================================================
   LAUNCHPAD — application shell (ORBIT's): sidebar, top bar, scroll container
   ========================================================================== */
...
import { TRACKS, TRACK_ORDER } from '@/curriculum/tracks'
...
export const NAV: NavDef[] = [
  ...
  { id: 'learning', label: 'Learning', path: '/learning', Icon: IconBook, also: ['/review', '/lesson', '/module'] },
...
/** APEX's realm launcher, one directory up from this app. */
export const REALMS_HREF = '../'
...
function Sidebar({
  ...
  return (
    <aside className="side" data-open={open} {...handlers}>
      ...
      <a className="nav-item nav-item--realms" href={REALMS_HREF} aria-label="Leave LAUNCHPAD and choose another realm">
